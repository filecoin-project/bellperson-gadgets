...
use crate::hash::hashes::Pedersen;
use crate::hash::{self, division_intractable as di, Hasher};
use crate::mp::bignat::BigNat;
use crate::rollup::sig::allocate_point;
use crate::rollup::tx::circuit::{CircuitAccount, CircuitSignedTx};
use crate::rollup::tx::{Account, Action, SignedTx, Tx, TxAccountChanges};
use crate::set::int_set::exp::serial::SerialExp;
use crate::set::int_set::ExpSet;
use crate::set::rsa::{CircuitSet, CircuitSetParams, Set};
use crate::set::{CircuitGenSet, GenSet};
    ...
    pub fn from_counts(
        ...
        let params = RollupBenchParams {
            ...
            set_params: RsaParams {
                group: RsaQuotientGroup::from_strs("2", RSA_2048),
                limb_width: 32,
                n_bits_base: 2048,
    ...
    H: Hasher<F = E::Fr> + CircuitHasher<E = E>,
{
    fn synthesize<CS: ConstraintSystem<E>>(mut self, cs: &mut CS) -> CResult<()> {
        ...
        let set: CircuitSet<
            ...
            ExpSet<RsaQuotientGroup, SerialExp<RsaQuotientGroup>>,
        > = CircuitSet::alloc(
