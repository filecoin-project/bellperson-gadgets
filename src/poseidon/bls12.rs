    ...
    pub fn new_for_params<H: GroupHasher>(t: u32, r_f: u32, r_p: u32, security_level: u32) -> Self {
        ...
        let full_round_constants = {
            ...
            loop {
                ...
                let mut constant_repr = <Fr as PrimeField>::Repr::default();
...
impl PoseidonHashParams<Bls12> for Bls12PoseidonParams {
    fn t(&self) -> u32 {
        self.t
    }
    fn r_f(&self) -> u32 {
