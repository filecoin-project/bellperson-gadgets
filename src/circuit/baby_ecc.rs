...
use crate::babyjubjub::{edwards, FixedGenerators, JubjubEngine, JubjubParams};
...
mod test {
    ...
    use crate::babyjubjub::{edwards, montgomery, FixedGenerators, JubjubBn256, JubjubParams};
